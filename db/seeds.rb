User.create(provider: "developer", uid: "jess@example.com", email: "jess@example.com", username: "Jess", full_name: "Jess", zip: "22820")
User.create(provider: "developer", uid: "alysia@example.com", email: "alysia@example.com", username: "Alysia", full_name: "Alysia", zip: "30370")
User.create(provider: "developer", uid: "deirdre@example.com", email: "deirdre@example.com", username: "Deirdre", full_name: "Deirdre", zip: "10003")
User.create(provider: "developer", uid: "llama@example.com", email: "llama@example.com", username: "Llama", full_name: "Llama", zip: "94070")
User.create(provider: "developer", uid: "puppy.party@example.com", email: "puppy.party@example.com", username: "Puppy Party", full_name: "Puppy Party", zip: "10009")
